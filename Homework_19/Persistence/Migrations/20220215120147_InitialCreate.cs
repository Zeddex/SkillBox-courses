        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientRefId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "DepartmentName", "DepositRate", "LoanRate" },
                values: new object[] { 1, "Individual", 5, 15 });

            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "DepartmentName", "DepositRate", "LoanRate" },
                values: new object[] { 2, "Business", 10, 10 });

            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "DepartmentName", "DepositRate", "LoanRate" },
                values: new object[] { 3, "Vip", 15, 5 });
            ...
            migrationBuilder.InsertData(
                table: "Money",
                columns: new[] { "ClientId", "Deposit", "DepositType", "Funds", "Loan" },
                values: new object[,]
                {
                    { 1, 0m, "No", 13922m, 0m },
                    { 28, 0m, "No", 11960m, 0m },
